    ...
    <div class="app-container">
      <el-card>
        ...
        <div v-if="type === 'personal'">
          <h2 class="centInfo" style="text-align: center">员工信息表</h2>
          <table cellspacing="0" width="100%" class="tableList">
            ...
            <tr>
              ...
              <td rowspan="5" style="width:10%"><img v-imgError="require('@/assets/common/head.jpg')" style="width:155px;height:218px" :src="formData.staffPhoto"></td>
            </tr>
            <tr>
              <th>性别</th>
        ...
        <div v-else>
          <h2 class="centInfo" style="text-align: center">岗位信息表</h2>      
          <table cellspacing="0" width="100%" class="tableList">
            <tr class="title">
