    ...
    <el-form label-width="220px">
      <div class="block">
        <el-row type="flex" justify="space-between" >
            <div class="title" style="line-height: 41px">基础信息</div>
            <el-button type="text" style="margin-right: 40px" @click="$router.push(`/employees/print/${userId}?type=userInfo`)">
...
<script >
import { getAllEmployees, updateJob, getJobDetail } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    async getAllEmployees() {
      this.depts = await getAllEmployees()
    }, // 获取员工列表
    async saveJob() {
